...
BASE = "/tmp/.cache"
os.environ.setdefault("HOME", "/vllm-workspace")
os.environ.setdefault("XDG_CACHE_HOME", f"{BASE}")
os.environ.setdefault("HF_HOME", f"{BASE}/huggingface")
os.environ.setdefault("HUGGINGFACE_HUB_CACHE", f"{BASE}/huggingface/hub")
os.environ.setdefault("HF_HUB_CACHE", f"{BASE}/huggingface/hub")
os.environ.setdefault("TRANSFORMERS_CACHE", f"{BASE}/huggingface/transformers")
os.environ.setdefault("HF_MODULES_CACHE", f"{BASE}/huggingface/modules")  # 动态模块缓存
os.environ.setdefault("TORCHINDUCTOR_CACHE_DIR", f"{BASE}/torchinductor")
